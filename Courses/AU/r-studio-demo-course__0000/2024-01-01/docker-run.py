...
START_COMMAND = "start_course -s req.sh -c class_01 -a"  # Start command for Docker container. Only relevant if INTERACTIVE_MODE = "False". To not use a start command, leave string empty.
...
IMAGE_NAME = "dreg.cloud.sdu.dk/ucloud-courses/au_r-studio-demo-course__0000:2024-01-01"
