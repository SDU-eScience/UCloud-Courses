...
START_COMMAND = "start_course -c class_01 -a"  # Start command for Docker container. Only relevant if INTERACTIVE_MODE = "False". To not use a start command, leave string empty.
